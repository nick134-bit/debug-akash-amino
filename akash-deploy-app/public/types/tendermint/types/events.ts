...
export const EventDataRoundState = {
  typeUrl: "/tendermint.types.EventDataRoundState",
  is(o: any): o is EventDataRoundState {
    return o && (o.$typeUrl === EventDataRoundState.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && typeof o.step === "string");
  },
  isSDK(o: any): o is EventDataRoundStateSDKType {
    return o && (o.$typeUrl === EventDataRoundState.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && typeof o.step === "string");
  },
  isAmino(o: any): o is EventDataRoundStateAmino {
    return o && (o.$typeUrl === EventDataRoundState.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && typeof o.step === "string");
  },
...
GlobalDecoderRegistry.register(EventDataRoundState.typeUrl, EventDataRoundState);