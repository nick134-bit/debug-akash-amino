...
export const NewRoundStep = {
  typeUrl: "/tendermint.consensus.NewRoundStep",
  is(o: any): o is NewRoundStep {
    return o && (o.$typeUrl === NewRoundStep.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && typeof o.step === "number" && typeof o.secondsSinceStartTime === "bigint" && typeof o.lastCommitRound === "number");
  },
  isSDK(o: any): o is NewRoundStepSDKType {
    return o && (o.$typeUrl === NewRoundStep.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && typeof o.step === "number" && typeof o.seconds_since_start_time === "bigint" && typeof o.last_commit_round === "number");
  },
  isAmino(o: any): o is NewRoundStepAmino {
    return o && (o.$typeUrl === NewRoundStep.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && typeof o.step === "number" && typeof o.seconds_since_start_time === "bigint" && typeof o.last_commit_round === "number");
  },
...
GlobalDecoderRegistry.register(NewRoundStep.typeUrl, NewRoundStep);
...
export const NewValidBlock = {
  typeUrl: "/tendermint.consensus.NewValidBlock",
  is(o: any): o is NewValidBlock {
    return o && (o.$typeUrl === NewValidBlock.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && PartSetHeader.is(o.blockPartSetHeader) && typeof o.isCommit === "boolean");
  },
  isSDK(o: any): o is NewValidBlockSDKType {
    return o && (o.$typeUrl === NewValidBlock.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && PartSetHeader.isSDK(o.block_part_set_header) && typeof o.is_commit === "boolean");
  },
  isAmino(o: any): o is NewValidBlockAmino {
    return o && (o.$typeUrl === NewValidBlock.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && PartSetHeader.isAmino(o.block_part_set_header) && typeof o.is_commit === "boolean");
  },
...
GlobalDecoderRegistry.register(NewValidBlock.typeUrl, NewValidBlock);
...
export const Proposal = {
  ...
  is(o: any): o is Proposal {
    return o && (o.$typeUrl === Proposal.typeUrl || Proposal1.is(o.proposal));
  },
  isSDK(o: any): o is ProposalSDKType {
    return o && (o.$typeUrl === Proposal.typeUrl || Proposal1.isSDK(o.proposal));
  },
  isAmino(o: any): o is ProposalAmino {
    return o && (o.$typeUrl === Proposal.typeUrl || Proposal1.isAmino(o.proposal));
  },
...
export const ProposalPOL = {
  typeUrl: "/tendermint.consensus.ProposalPOL",
  is(o: any): o is ProposalPOL {
    return o && (o.$typeUrl === ProposalPOL.typeUrl || typeof o.height === "bigint" && typeof o.proposalPolRound === "number" && BitArray.is(o.proposalPol));
  },
  isSDK(o: any): o is ProposalPOLSDKType {
    return o && (o.$typeUrl === ProposalPOL.typeUrl || typeof o.height === "bigint" && typeof o.proposal_pol_round === "number" && BitArray.isSDK(o.proposal_pol));
  },
  isAmino(o: any): o is ProposalPOLAmino {
    return o && (o.$typeUrl === ProposalPOL.typeUrl || typeof o.height === "bigint" && typeof o.proposal_pol_round === "number" && BitArray.isAmino(o.proposal_pol));
  },
...
GlobalDecoderRegistry.register(ProposalPOL.typeUrl, ProposalPOL);
...
export const BlockPart = {
  typeUrl: "/tendermint.consensus.BlockPart",
  is(o: any): o is BlockPart {
    return o && (o.$typeUrl === BlockPart.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && Part.is(o.part));
  },
  isSDK(o: any): o is BlockPartSDKType {
    return o && (o.$typeUrl === BlockPart.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && Part.isSDK(o.part));
  },
  isAmino(o: any): o is BlockPartAmino {
    return o && (o.$typeUrl === BlockPart.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && Part.isAmino(o.part));
  },
...
GlobalDecoderRegistry.register(BlockPart.typeUrl, BlockPart);
...
export const Vote = {
  typeUrl: "/tendermint.consensus.Vote",
  is(o: any): o is Vote {
    return o && o.$typeUrl === Vote.typeUrl;
  },
...
export const HasVote = {
  typeUrl: "/tendermint.consensus.HasVote",
  is(o: any): o is HasVote {
    return o && (o.$typeUrl === HasVote.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && isSet(o.type) && typeof o.index === "number");
  },
  isSDK(o: any): o is HasVoteSDKType {
    return o && (o.$typeUrl === HasVote.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && isSet(o.type) && typeof o.index === "number");
  },
  isAmino(o: any): o is HasVoteAmino {
    return o && (o.$typeUrl === HasVote.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && isSet(o.type) && typeof o.index === "number");
  },
...
GlobalDecoderRegistry.register(HasVote.typeUrl, HasVote);
...
export const VoteSetMaj23 = {
  typeUrl: "/tendermint.consensus.VoteSetMaj23",
  is(o: any): o is VoteSetMaj23 {
    return o && (o.$typeUrl === VoteSetMaj23.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && isSet(o.type) && BlockID.is(o.blockId));
  },
  isSDK(o: any): o is VoteSetMaj23SDKType {
    return o && (o.$typeUrl === VoteSetMaj23.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && isSet(o.type) && BlockID.isSDK(o.block_id));
  },
  isAmino(o: any): o is VoteSetMaj23Amino {
    return o && (o.$typeUrl === VoteSetMaj23.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && isSet(o.type) && BlockID.isAmino(o.block_id));
  },
...
GlobalDecoderRegistry.register(VoteSetMaj23.typeUrl, VoteSetMaj23);
...
export const VoteSetBits = {
  typeUrl: "/tendermint.consensus.VoteSetBits",
  is(o: any): o is VoteSetBits {
    return o && (o.$typeUrl === VoteSetBits.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && isSet(o.type) && BlockID.is(o.blockId) && BitArray.is(o.votes));
  },
  isSDK(o: any): o is VoteSetBitsSDKType {
    return o && (o.$typeUrl === VoteSetBits.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && isSet(o.type) && BlockID.isSDK(o.block_id) && BitArray.isSDK(o.votes));
  },
  isAmino(o: any): o is VoteSetBitsAmino {
    return o && (o.$typeUrl === VoteSetBits.typeUrl || typeof o.height === "bigint" && typeof o.round === "number" && isSet(o.type) && BlockID.isAmino(o.block_id) && BitArray.isAmino(o.votes));
  },
...
GlobalDecoderRegistry.register(VoteSetBits.typeUrl, VoteSetBits);
