...
export const RequestPing = {
  typeUrl: "/tendermint.rpc.grpc.RequestPing",
  is(o: any): o is RequestPing {
    return o && o.$typeUrl === RequestPing.typeUrl;
  },
  isSDK(o: any): o is RequestPingSDKType {
    return o && o.$typeUrl === RequestPing.typeUrl;
  },
  isAmino(o: any): o is RequestPingAmino {
    return o && o.$typeUrl === RequestPing.typeUrl;
  },
...
GlobalDecoderRegistry.register(RequestPing.typeUrl, RequestPing);
...
export const RequestBroadcastTx = {
  typeUrl: "/tendermint.rpc.grpc.RequestBroadcastTx",
  is(o: any): o is RequestBroadcastTx {
    return o && (o.$typeUrl === RequestBroadcastTx.typeUrl || o.tx instanceof Uint8Array || typeof o.tx === "string");
  },
  isSDK(o: any): o is RequestBroadcastTxSDKType {
    return o && (o.$typeUrl === RequestBroadcastTx.typeUrl || o.tx instanceof Uint8Array || typeof o.tx === "string");
  },
  isAmino(o: any): o is RequestBroadcastTxAmino {
    return o && (o.$typeUrl === RequestBroadcastTx.typeUrl || o.tx instanceof Uint8Array || typeof o.tx === "string");
  },
...
GlobalDecoderRegistry.register(RequestBroadcastTx.typeUrl, RequestBroadcastTx);
function createBaseResponsePing(): ResponsePing {
  return {};
}
export const ResponsePing = {
  typeUrl: "/tendermint.rpc.grpc.ResponsePing",
  is(o: any): o is ResponsePing {
    return o && o.$typeUrl === ResponsePing.typeUrl;
  },
  isSDK(o: any): o is ResponsePingSDKType {
    return o && o.$typeUrl === ResponsePing.typeUrl;
  },
  isAmino(o: any): o is ResponsePingAmino {
    return o && o.$typeUrl === ResponsePing.typeUrl;
  },
...
GlobalDecoderRegistry.register(ResponsePing.typeUrl, ResponsePing);
...
export const ResponseBroadcastTx = {
  typeUrl: "/tendermint.rpc.grpc.ResponseBroadcastTx",
  is(o: any): o is ResponseBroadcastTx {
    return o && o.$typeUrl === ResponseBroadcastTx.typeUrl;
  },
  isSDK(o: any): o is ResponseBroadcastTxSDKType {
    return o && o.$typeUrl === ResponseBroadcastTx.typeUrl;
  },
  isAmino(o: any): o is ResponseBroadcastTxAmino {
    return o && o.$typeUrl === ResponseBroadcastTx.typeUrl;
  },
...
GlobalDecoderRegistry.register(ResponseBroadcastTx.typeUrl, ResponseBroadcastTx);