...
export const PacketPing = {
  typeUrl: "/tendermint.p2p.PacketPing",
  is(o: any): o is PacketPing {
    return o && o.$typeUrl === PacketPing.typeUrl;
  },
  isSDK(o: any): o is PacketPingSDKType {
    return o && o.$typeUrl === PacketPing.typeUrl;
  },
  isAmino(o: any): o is PacketPingAmino {
    return o && o.$typeUrl === PacketPing.typeUrl;
  },
...
GlobalDecoderRegistry.register(PacketPing.typeUrl, PacketPing);
function createBasePacketPong(): PacketPong {
  return {};
}
export const PacketPong = {
  typeUrl: "/tendermint.p2p.PacketPong",
  is(o: any): o is PacketPong {
    return o && o.$typeUrl === PacketPong.typeUrl;
  },
  isSDK(o: any): o is PacketPongSDKType {
    return o && o.$typeUrl === PacketPong.typeUrl;
  },
  isAmino(o: any): o is PacketPongAmino {
    return o && o.$typeUrl === PacketPong.typeUrl;
  },
...
GlobalDecoderRegistry.register(PacketPong.typeUrl, PacketPong);
...
export const PacketMsg = {
  typeUrl: "/tendermint.p2p.PacketMsg",
  is(o: any): o is PacketMsg {
    return o && (o.$typeUrl === PacketMsg.typeUrl || typeof o.channelId === "number" && typeof o.eof === "boolean" && (o.data instanceof Uint8Array || typeof o.data === "string"));
  },
  isSDK(o: any): o is PacketMsgSDKType {
    return o && (o.$typeUrl === PacketMsg.typeUrl || typeof o.channel_id === "number" && typeof o.eof === "boolean" && (o.data instanceof Uint8Array || typeof o.data === "string"));
  },
  isAmino(o: any): o is PacketMsgAmino {
    return o && (o.$typeUrl === PacketMsg.typeUrl || typeof o.channel_id === "number" && typeof o.eof === "boolean" && (o.data instanceof Uint8Array || typeof o.data === "string"));
  },
...
GlobalDecoderRegistry.register(PacketMsg.typeUrl, PacketMsg);
...
export const Packet = {
  ...
  is(o: any): o is Packet {
    return o && o.$typeUrl === Packet.typeUrl;
  },
...
export const AuthSigMessage = {
  typeUrl: "/tendermint.p2p.AuthSigMessage",
  is(o: any): o is AuthSigMessage {
    return o && (o.$typeUrl === AuthSigMessage.typeUrl || PublicKey.is(o.pubKey) && (o.sig instanceof Uint8Array || typeof o.sig === "string"));
  },
  isSDK(o: any): o is AuthSigMessageSDKType {
    return o && (o.$typeUrl === AuthSigMessage.typeUrl || PublicKey.isSDK(o.pub_key) && (o.sig instanceof Uint8Array || typeof o.sig === "string"));
  },
  isAmino(o: any): o is AuthSigMessageAmino {
    return o && (o.$typeUrl === AuthSigMessage.typeUrl || PublicKey.isAmino(o.pub_key) && (o.sig instanceof Uint8Array || typeof o.sig === "string"));
  },
...
GlobalDecoderRegistry.register(AuthSigMessage.typeUrl, AuthSigMessage);