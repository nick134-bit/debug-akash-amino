...
export const PexRequest = {
  typeUrl: "/tendermint.p2p.PexRequest",
  is(o: any): o is PexRequest {
    return o && o.$typeUrl === PexRequest.typeUrl;
  },
  isSDK(o: any): o is PexRequestSDKType {
    return o && o.$typeUrl === PexRequest.typeUrl;
  },
  isAmino(o: any): o is PexRequestAmino {
    return o && o.$typeUrl === PexRequest.typeUrl;
  },
...
GlobalDecoderRegistry.register(PexRequest.typeUrl, PexRequest);
...
export const PexAddrs = {
  typeUrl: "/tendermint.p2p.PexAddrs",
  is(o: any): o is PexAddrs {
    return o && (o.$typeUrl === PexAddrs.typeUrl || Array.isArray(o.addrs) && (!o.addrs.length || NetAddress.is(o.addrs[0])));
  },
  isSDK(o: any): o is PexAddrsSDKType {
    return o && (o.$typeUrl === PexAddrs.typeUrl || Array.isArray(o.addrs) && (!o.addrs.length || NetAddress.isSDK(o.addrs[0])));
  },
  isAmino(o: any): o is PexAddrsAmino {
    return o && (o.$typeUrl === PexAddrs.typeUrl || Array.isArray(o.addrs) && (!o.addrs.length || NetAddress.isAmino(o.addrs[0])));
  },
...
GlobalDecoderRegistry.register(PexAddrs.typeUrl, PexAddrs);
