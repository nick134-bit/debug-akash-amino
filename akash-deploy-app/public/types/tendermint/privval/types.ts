...
export const RemoteSignerError = {
  typeUrl: "/tendermint.privval.RemoteSignerError",
  is(o: any): o is RemoteSignerError {
    return o && (o.$typeUrl === RemoteSignerError.typeUrl || typeof o.code === "number" && typeof o.description === "string");
  },
  isSDK(o: any): o is RemoteSignerErrorSDKType {
    return o && (o.$typeUrl === RemoteSignerError.typeUrl || typeof o.code === "number" && typeof o.description === "string");
  },
  isAmino(o: any): o is RemoteSignerErrorAmino {
    return o && (o.$typeUrl === RemoteSignerError.typeUrl || typeof o.code === "number" && typeof o.description === "string");
  },
...
GlobalDecoderRegistry.register(RemoteSignerError.typeUrl, RemoteSignerError);
...
export const PubKeyRequest = {
  typeUrl: "/tendermint.privval.PubKeyRequest",
  is(o: any): o is PubKeyRequest {
    return o && (o.$typeUrl === PubKeyRequest.typeUrl || typeof o.chainId === "string");
  },
  isSDK(o: any): o is PubKeyRequestSDKType {
    return o && (o.$typeUrl === PubKeyRequest.typeUrl || typeof o.chain_id === "string");
  },
  isAmino(o: any): o is PubKeyRequestAmino {
    return o && (o.$typeUrl === PubKeyRequest.typeUrl || typeof o.chain_id === "string");
  },
...
GlobalDecoderRegistry.register(PubKeyRequest.typeUrl, PubKeyRequest);
...
export const PubKeyResponse = {
  typeUrl: "/tendermint.privval.PubKeyResponse",
  is(o: any): o is PubKeyResponse {
    return o && (o.$typeUrl === PubKeyResponse.typeUrl || PublicKey.is(o.pubKey));
  },
  isSDK(o: any): o is PubKeyResponseSDKType {
    return o && (o.$typeUrl === PubKeyResponse.typeUrl || PublicKey.isSDK(o.pub_key));
  },
  isAmino(o: any): o is PubKeyResponseAmino {
    return o && (o.$typeUrl === PubKeyResponse.typeUrl || PublicKey.isAmino(o.pub_key));
  },
...
GlobalDecoderRegistry.register(PubKeyResponse.typeUrl, PubKeyResponse);
...
export const SignVoteRequest = {
  typeUrl: "/tendermint.privval.SignVoteRequest",
  is(o: any): o is SignVoteRequest {
    return o && (o.$typeUrl === SignVoteRequest.typeUrl || typeof o.chainId === "string");
  },
  isSDK(o: any): o is SignVoteRequestSDKType {
    return o && (o.$typeUrl === SignVoteRequest.typeUrl || typeof o.chain_id === "string");
  },
  isAmino(o: any): o is SignVoteRequestAmino {
    return o && (o.$typeUrl === SignVoteRequest.typeUrl || typeof o.chain_id === "string");
  },
...
GlobalDecoderRegistry.register(SignVoteRequest.typeUrl, SignVoteRequest);
...
export const SignedVoteResponse = {
  typeUrl: "/tendermint.privval.SignedVoteResponse",
  is(o: any): o is SignedVoteResponse {
    return o && (o.$typeUrl === SignedVoteResponse.typeUrl || Vote.is(o.vote));
  },
  isSDK(o: any): o is SignedVoteResponseSDKType {
    return o && (o.$typeUrl === SignedVoteResponse.typeUrl || Vote.isSDK(o.vote));
  },
  isAmino(o: any): o is SignedVoteResponseAmino {
    return o && (o.$typeUrl === SignedVoteResponse.typeUrl || Vote.isAmino(o.vote));
  },
...
GlobalDecoderRegistry.register(SignedVoteResponse.typeUrl, SignedVoteResponse);
...
export const SignProposalRequest = {
  typeUrl: "/tendermint.privval.SignProposalRequest",
  is(o: any): o is SignProposalRequest {
    return o && (o.$typeUrl === SignProposalRequest.typeUrl || typeof o.chainId === "string");
  },
  isSDK(o: any): o is SignProposalRequestSDKType {
    return o && (o.$typeUrl === SignProposalRequest.typeUrl || typeof o.chain_id === "string");
  },
  isAmino(o: any): o is SignProposalRequestAmino {
    return o && (o.$typeUrl === SignProposalRequest.typeUrl || typeof o.chain_id === "string");
  },
...
GlobalDecoderRegistry.register(SignProposalRequest.typeUrl, SignProposalRequest);
...
export const SignedProposalResponse = {
  typeUrl: "/tendermint.privval.SignedProposalResponse",
  is(o: any): o is SignedProposalResponse {
    return o && (o.$typeUrl === SignedProposalResponse.typeUrl || Proposal.is(o.proposal));
  },
  isSDK(o: any): o is SignedProposalResponseSDKType {
    return o && (o.$typeUrl === SignedProposalResponse.typeUrl || Proposal.isSDK(o.proposal));
  },
  isAmino(o: any): o is SignedProposalResponseAmino {
    return o && (o.$typeUrl === SignedProposalResponse.typeUrl || Proposal.isAmino(o.proposal));
  },
...
GlobalDecoderRegistry.register(SignedProposalResponse.typeUrl, SignedProposalResponse);
function createBasePingRequest(): PingRequest {
  return {};
}
export const PingRequest = {
  typeUrl: "/tendermint.privval.PingRequest",
  is(o: any): o is PingRequest {
    return o && o.$typeUrl === PingRequest.typeUrl;
  },
  isSDK(o: any): o is PingRequestSDKType {
    return o && o.$typeUrl === PingRequest.typeUrl;
  },
  isAmino(o: any): o is PingRequestAmino {
    return o && o.$typeUrl === PingRequest.typeUrl;
  },
...
GlobalDecoderRegistry.register(PingRequest.typeUrl, PingRequest);
function createBasePingResponse(): PingResponse {
  return {};
}
export const PingResponse = {
  typeUrl: "/tendermint.privval.PingResponse",
  is(o: any): o is PingResponse {
    return o && o.$typeUrl === PingResponse.typeUrl;
  },
  isSDK(o: any): o is PingResponseSDKType {
    return o && o.$typeUrl === PingResponse.typeUrl;
  },
  isAmino(o: any): o is PingResponseAmino {
    return o && o.$typeUrl === PingResponse.typeUrl;
  },
...
GlobalDecoderRegistry.register(PingResponse.typeUrl, PingResponse);
