...
export const MsgInfo = {
  typeUrl: "/tendermint.consensus.MsgInfo",
  is(o: any): o is MsgInfo {
    return o && (o.$typeUrl === MsgInfo.typeUrl || Message.is(o.msg) && typeof o.peerId === "string");
  },
  isSDK(o: any): o is MsgInfoSDKType {
    return o && (o.$typeUrl === MsgInfo.typeUrl || Message.isSDK(o.msg) && typeof o.peer_id === "string");
  },
  isAmino(o: any): o is MsgInfoAmino {
    return o && (o.$typeUrl === MsgInfo.typeUrl || Message.isAmino(o.msg) && typeof o.peer_id === "string");
  },
...
GlobalDecoderRegistry.register(MsgInfo.typeUrl, MsgInfo);
...
export const TimeoutInfo = {
  typeUrl: "/tendermint.consensus.TimeoutInfo",
  is(o: any): o is TimeoutInfo {
    return o && (o.$typeUrl === TimeoutInfo.typeUrl || Duration.is(o.duration) && typeof o.height === "bigint" && typeof o.round === "number" && typeof o.step === "number");
  },
  isSDK(o: any): o is TimeoutInfoSDKType {
    return o && (o.$typeUrl === TimeoutInfo.typeUrl || Duration.isSDK(o.duration) && typeof o.height === "bigint" && typeof o.round === "number" && typeof o.step === "number");
  },
  isAmino(o: any): o is TimeoutInfoAmino {
    return o && (o.$typeUrl === TimeoutInfo.typeUrl || Duration.isAmino(o.duration) && typeof o.height === "bigint" && typeof o.round === "number" && typeof o.step === "number");
  },
...
GlobalDecoderRegistry.register(TimeoutInfo.typeUrl, TimeoutInfo);
...
export const EndHeight = {
  typeUrl: "/tendermint.consensus.EndHeight",
  is(o: any): o is EndHeight {
    return o && (o.$typeUrl === EndHeight.typeUrl || typeof o.height === "bigint");
  },
  isSDK(o: any): o is EndHeightSDKType {
    return o && (o.$typeUrl === EndHeight.typeUrl || typeof o.height === "bigint");
  },
  isAmino(o: any): o is EndHeightAmino {
    return o && (o.$typeUrl === EndHeight.typeUrl || typeof o.height === "bigint");
  },
...
GlobalDecoderRegistry.register(EndHeight.typeUrl, EndHeight);
...
export const WALMessage = {
  typeUrl: "/tendermint.consensus.WALMessage",
  is(o: any): o is WALMessage {
    return o && o.$typeUrl === WALMessage.typeUrl;
  },
  isSDK(o: any): o is WALMessageSDKType {
    return o && o.$typeUrl === WALMessage.typeUrl;
  },
  isAmino(o: any): o is WALMessageAmino {
    return o && o.$typeUrl === WALMessage.typeUrl;
  },
...
GlobalDecoderRegistry.register(WALMessage.typeUrl, WALMessage);
...
export const TimedWALMessage = {
  typeUrl: "/tendermint.consensus.TimedWALMessage",
  is(o: any): o is TimedWALMessage {
    return o && (o.$typeUrl === TimedWALMessage.typeUrl || Timestamp.is(o.time));
  },
  isSDK(o: any): o is TimedWALMessageSDKType {
    return o && (o.$typeUrl === TimedWALMessage.typeUrl || Timestamp.isSDK(o.time));
  },
  isAmino(o: any): o is TimedWALMessageAmino {
    return o && (o.$typeUrl === TimedWALMessage.typeUrl || Timestamp.isAmino(o.time));
  },
...
GlobalDecoderRegistry.register(TimedWALMessage.typeUrl, TimedWALMessage);