...
export const BlockStoreState = {
  typeUrl: "/tendermint.store.BlockStoreState",
  is(o: any): o is BlockStoreState {
    return o && (o.$typeUrl === BlockStoreState.typeUrl || typeof o.base === "bigint" && typeof o.height === "bigint");
  },
  isSDK(o: any): o is BlockStoreStateSDKType {
    return o && (o.$typeUrl === BlockStoreState.typeUrl || typeof o.base === "bigint" && typeof o.height === "bigint");
  },
  isAmino(o: any): o is BlockStoreStateAmino {
    return o && (o.$typeUrl === BlockStoreState.typeUrl || typeof o.base === "bigint" && typeof o.height === "bigint");
  },
...
GlobalDecoderRegistry.register(BlockStoreState.typeUrl, BlockStoreState);