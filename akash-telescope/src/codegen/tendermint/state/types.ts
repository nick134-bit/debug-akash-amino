...
export const ABCIResponses = {
  typeUrl: "/tendermint.state.ABCIResponses",
  is(o: any): o is ABCIResponses {
    return o && (o.$typeUrl === ABCIResponses.typeUrl || Array.isArray(o.deliverTxs) && (!o.deliverTxs.length || ResponseDeliverTx.is(o.deliverTxs[0])));
  },
  isSDK(o: any): o is ABCIResponsesSDKType {
    return o && (o.$typeUrl === ABCIResponses.typeUrl || Array.isArray(o.deliver_txs) && (!o.deliver_txs.length || ResponseDeliverTx.isSDK(o.deliver_txs[0])));
  },
  isAmino(o: any): o is ABCIResponsesAmino {
    return o && (o.$typeUrl === ABCIResponses.typeUrl || Array.isArray(o.deliver_txs) && (!o.deliver_txs.length || ResponseDeliverTx.isAmino(o.deliver_txs[0])));
  },
...
GlobalDecoderRegistry.register(ABCIResponses.typeUrl, ABCIResponses);
...
export const ValidatorsInfo = {
  typeUrl: "/tendermint.state.ValidatorsInfo",
  is(o: any): o is ValidatorsInfo {
    return o && (o.$typeUrl === ValidatorsInfo.typeUrl || typeof o.lastHeightChanged === "bigint");
  },
  isSDK(o: any): o is ValidatorsInfoSDKType {
    return o && (o.$typeUrl === ValidatorsInfo.typeUrl || typeof o.last_height_changed === "bigint");
  },
  isAmino(o: any): o is ValidatorsInfoAmino {
    return o && (o.$typeUrl === ValidatorsInfo.typeUrl || typeof o.last_height_changed === "bigint");
  },
...
GlobalDecoderRegistry.register(ValidatorsInfo.typeUrl, ValidatorsInfo);
...
export const ConsensusParamsInfo = {
  typeUrl: "/tendermint.state.ConsensusParamsInfo",
  is(o: any): o is ConsensusParamsInfo {
    return o && (o.$typeUrl === ConsensusParamsInfo.typeUrl || ConsensusParams.is(o.consensusParams) && typeof o.lastHeightChanged === "bigint");
  },
  isSDK(o: any): o is ConsensusParamsInfoSDKType {
    return o && (o.$typeUrl === ConsensusParamsInfo.typeUrl || ConsensusParams.isSDK(o.consensus_params) && typeof o.last_height_changed === "bigint");
  },
  isAmino(o: any): o is ConsensusParamsInfoAmino {
    return o && (o.$typeUrl === ConsensusParamsInfo.typeUrl || ConsensusParams.isAmino(o.consensus_params) && typeof o.last_height_changed === "bigint");
  },
...
GlobalDecoderRegistry.register(ConsensusParamsInfo.typeUrl, ConsensusParamsInfo);
...
export const ABCIResponsesInfo = {
  typeUrl: "/tendermint.state.ABCIResponsesInfo",
  is(o: any): o is ABCIResponsesInfo {
    return o && (o.$typeUrl === ABCIResponsesInfo.typeUrl || typeof o.height === "bigint");
  },
  isSDK(o: any): o is ABCIResponsesInfoSDKType {
    return o && (o.$typeUrl === ABCIResponsesInfo.typeUrl || typeof o.height === "bigint");
  },
  isAmino(o: any): o is ABCIResponsesInfoAmino {
    return o && (o.$typeUrl === ABCIResponsesInfo.typeUrl || typeof o.height === "bigint");
  },
...
GlobalDecoderRegistry.register(ABCIResponsesInfo.typeUrl, ABCIResponsesInfo);
...
export const Version = {
  ...
  is(o: any): o is Version {
    return o && (o.$typeUrl === Version.typeUrl || Consensus.is(o.consensus) && typeof o.software === "string");
  },
  isSDK(o: any): o is VersionSDKType {
    return o && (o.$typeUrl === Version.typeUrl || Consensus.isSDK(o.consensus) && typeof o.software === "string");
  },
  isAmino(o: any): o is VersionAmino {
    return o && (o.$typeUrl === Version.typeUrl || Consensus.isAmino(o.consensus) && typeof o.software === "string");
  },
...
export const State = {
  typeUrl: "/tendermint.state.State",
  is(o: any): o is State {
    return o && (o.$typeUrl === State.typeUrl || Version.is(o.version) && typeof o.chainId === "string" && typeof o.initialHeight === "bigint" && typeof o.lastBlockHeight === "bigint" && BlockID.is(o.lastBlockId) && Timestamp.is(o.lastBlockTime) && typeof o.lastHeightValidatorsChanged === "bigint" && ConsensusParams.is(o.consensusParams) && typeof o.lastHeightConsensusParamsChanged === "bigint" && (o.lastResultsHash instanceof Uint8Array || typeof o.lastResultsHash === "string") && (o.appHash instanceof Uint8Array || typeof o.appHash === "string"));
  },
  isSDK(o: any): o is StateSDKType {
    return o && (o.$typeUrl === State.typeUrl || Version.isSDK(o.version) && typeof o.chain_id === "string" && typeof o.initial_height === "bigint" && typeof o.last_block_height === "bigint" && BlockID.isSDK(o.last_block_id) && Timestamp.isSDK(o.last_block_time) && typeof o.last_height_validators_changed === "bigint" && ConsensusParams.isSDK(o.consensus_params) && typeof o.last_height_consensus_params_changed === "bigint" && (o.last_results_hash instanceof Uint8Array || typeof o.last_results_hash === "string") && (o.app_hash instanceof Uint8Array || typeof o.app_hash === "string"));
  },
  isAmino(o: any): o is StateAmino {
    return o && (o.$typeUrl === State.typeUrl || Version.isAmino(o.version) && typeof o.chain_id === "string" && typeof o.initial_height === "bigint" && typeof o.last_block_height === "bigint" && BlockID.isAmino(o.last_block_id) && Timestamp.isAmino(o.last_block_time) && typeof o.last_height_validators_changed === "bigint" && ConsensusParams.isAmino(o.consensus_params) && typeof o.last_height_consensus_params_changed === "bigint" && (o.last_results_hash instanceof Uint8Array || typeof o.last_results_hash === "string") && (o.app_hash instanceof Uint8Array || typeof o.app_hash === "string"));
  },
