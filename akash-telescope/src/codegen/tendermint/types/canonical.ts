...
import { bytesFromBase64, base64FromBytes, isSet, toTimestamp, fromTimestamp } from "../../helpers";
...
export const CanonicalBlockID = {
  typeUrl: "/tendermint.types.CanonicalBlockID",
  is(o: any): o is CanonicalBlockID {
    return o && (o.$typeUrl === CanonicalBlockID.typeUrl || (o.hash instanceof Uint8Array || typeof o.hash === "string") && CanonicalPartSetHeader.is(o.partSetHeader));
  },
  isSDK(o: any): o is CanonicalBlockIDSDKType {
    return o && (o.$typeUrl === CanonicalBlockID.typeUrl || (o.hash instanceof Uint8Array || typeof o.hash === "string") && CanonicalPartSetHeader.isSDK(o.part_set_header));
  },
  isAmino(o: any): o is CanonicalBlockIDAmino {
    return o && (o.$typeUrl === CanonicalBlockID.typeUrl || (o.hash instanceof Uint8Array || typeof o.hash === "string") && CanonicalPartSetHeader.isAmino(o.part_set_header));
  },
...
GlobalDecoderRegistry.register(CanonicalBlockID.typeUrl, CanonicalBlockID);
...
export const CanonicalPartSetHeader = {
  typeUrl: "/tendermint.types.CanonicalPartSetHeader",
  is(o: any): o is CanonicalPartSetHeader {
    return o && (o.$typeUrl === CanonicalPartSetHeader.typeUrl || typeof o.total === "number" && (o.hash instanceof Uint8Array || typeof o.hash === "string"));
  },
  isSDK(o: any): o is CanonicalPartSetHeaderSDKType {
    return o && (o.$typeUrl === CanonicalPartSetHeader.typeUrl || typeof o.total === "number" && (o.hash instanceof Uint8Array || typeof o.hash === "string"));
  },
  isAmino(o: any): o is CanonicalPartSetHeaderAmino {
    return o && (o.$typeUrl === CanonicalPartSetHeader.typeUrl || typeof o.total === "number" && (o.hash instanceof Uint8Array || typeof o.hash === "string"));
  },
...
GlobalDecoderRegistry.register(CanonicalPartSetHeader.typeUrl, CanonicalPartSetHeader);
...
export const CanonicalProposal = {
  typeUrl: "/tendermint.types.CanonicalProposal",
  is(o: any): o is CanonicalProposal {
    return o && (o.$typeUrl === CanonicalProposal.typeUrl || isSet(o.type) && typeof o.height === "bigint" && typeof o.round === "bigint" && typeof o.polRound === "bigint" && Timestamp.is(o.timestamp) && typeof o.chainId === "string");
  },
  isSDK(o: any): o is CanonicalProposalSDKType {
    return o && (o.$typeUrl === CanonicalProposal.typeUrl || isSet(o.type) && typeof o.height === "bigint" && typeof o.round === "bigint" && typeof o.pol_round === "bigint" && Timestamp.isSDK(o.timestamp) && typeof o.chain_id === "string");
  },
  isAmino(o: any): o is CanonicalProposalAmino {
    return o && (o.$typeUrl === CanonicalProposal.typeUrl || isSet(o.type) && typeof o.height === "bigint" && typeof o.round === "bigint" && typeof o.pol_round === "bigint" && Timestamp.isAmino(o.timestamp) && typeof o.chain_id === "string");
  },
...
GlobalDecoderRegistry.register(CanonicalProposal.typeUrl, CanonicalProposal);
...
export const CanonicalVote = {
  typeUrl: "/tendermint.types.CanonicalVote",
  is(o: any): o is CanonicalVote {
    return o && (o.$typeUrl === CanonicalVote.typeUrl || isSet(o.type) && typeof o.height === "bigint" && typeof o.round === "bigint" && Timestamp.is(o.timestamp) && typeof o.chainId === "string");
  },
  isSDK(o: any): o is CanonicalVoteSDKType {
    return o && (o.$typeUrl === CanonicalVote.typeUrl || isSet(o.type) && typeof o.height === "bigint" && typeof o.round === "bigint" && Timestamp.isSDK(o.timestamp) && typeof o.chain_id === "string");
  },
  isAmino(o: any): o is CanonicalVoteAmino {
    return o && (o.$typeUrl === CanonicalVote.typeUrl || isSet(o.type) && typeof o.height === "bigint" && typeof o.round === "bigint" && Timestamp.isAmino(o.timestamp) && typeof o.chain_id === "string");
  },
...
GlobalDecoderRegistry.register(CanonicalVote.typeUrl, CanonicalVote);