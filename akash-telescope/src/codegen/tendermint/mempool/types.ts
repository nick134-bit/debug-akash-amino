...
export const Txs = {
  typeUrl: "/tendermint.mempool.Txs",
  is(o: any): o is Txs {
    return o && (o.$typeUrl === Txs.typeUrl || Array.isArray(o.txs) && (!o.txs.length || o.txs[0] instanceof Uint8Array || typeof o.txs[0] === "string"));
  },
  isSDK(o: any): o is TxsSDKType {
    return o && (o.$typeUrl === Txs.typeUrl || Array.isArray(o.txs) && (!o.txs.length || o.txs[0] instanceof Uint8Array || typeof o.txs[0] === "string"));
  },
  isAmino(o: any): o is TxsAmino {
    return o && (o.$typeUrl === Txs.typeUrl || Array.isArray(o.txs) && (!o.txs.length || o.txs[0] instanceof Uint8Array || typeof o.txs[0] === "string"));
  },
...
GlobalDecoderRegistry.register(Txs.typeUrl, Txs);
